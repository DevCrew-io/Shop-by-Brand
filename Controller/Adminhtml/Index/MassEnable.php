...
/**
 * Mass enable controller class to perform mass enable action
 *
 * Class MassEnable
 */
class MassEnable extends Brand
{
    /**
     * @var Filter
     */
    ...
    /**
     * Execute method to perform brand mass enable action
     *
    ...
    public function execute()
    {
        ...
        foreach ($collection as $item) {
            try {
                $item->setStatus(BrandModel::STATUS_ENABLED);
        ...
        $this->messageManager->addSuccessMessage(
            __('A total of %1 record(s) have been enabled.', $recordDisabled)
        );
